...
class playerUI(object):
    def setupUi(self, Form):
        ...
        self.add_fav_btn = QtWidgets.QPushButton(self.layoutWidget)
        self.add_fav_btn.setObjectName("add_fav_btn")
        self.verticalLayout_2.addWidget(self.add_fav_btn)
    ...
    def retranslateUi(self, Form):
        ...
        self.add_fav_btn.setText(_translate("Form", "add to favorite"))
